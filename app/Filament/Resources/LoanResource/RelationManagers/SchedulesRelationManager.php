...
class SchedulesRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('amount_due')->label('Montant dû')->numeric(decimalPlaces: 2)->suffix(' ' . \App\Models\Setting::get('currency', 'Gourdes')),
            Tables\Columns\TextColumn::make('amount_paid')->label('Payé')->numeric(decimalPlaces: 2)->suffix(' ' . \App\Models\Setting::get('currency', 'Gourdes')),
