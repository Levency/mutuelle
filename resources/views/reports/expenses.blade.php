...
<div class="content">
    <div class="summary">Total des dépenses sur la période : <span>{{ \App\Models\Setting::get('currency', 'Gourdes') }} {{ number_format($total, 2) }}</span></div>
    <table>
        <thead>
            <tr>
                <th>Date</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $e->description }}</td>
                <td style="text-align:right; font-weight:bold">{{ \App\Models\Setting::get('currency', 'Gourdes') }} {{ number_format($e->amount, 2) }}</td>
