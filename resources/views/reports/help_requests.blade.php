...
<div class="content">
    <div class="summary">
        Montant total approuvé : <span>$ {{ number_format($total_approved, 2) }}</span> &nbsp;|&nbsp;
        En attente : <span style="color:#dc2626">{{ $pending_count }}</span>
    </div>
    <table>
        <thead>
            <tr><th>#</th><th>Membre</th><th>Motif</th><th>Montant ($)</th><th>Statut</th><th>Date</th></tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $hr->reason ?? '—' }}</td>
                <td style="text-align:right; font-weight:bold">$ {{ number_format($hr->amount, 2) }}</td>
