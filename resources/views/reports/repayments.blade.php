...
<div class="content">
    <div class="summary">Total remboursé : <span>{{ \App\Models\Setting::get('currency', 'Gourdes') }} {{ number_format($total, 2) }}</span></div>
    <table>
        <thead>
            <tr><th>#</th><th>Membre</th><th>Prêt #</th><th>Montant {{ \App\Models\Setting::get('currency', 'Gourdes') }}</th><th>Date</th><th>Notes</th></tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>#{{ $r->loan_id }}</td>
                <td style="text-align:right; font-weight:bold; color:#0891b2">{{ \App\Models\Setting::get('currency', 'Gourdes') }} {{ number_format($r->amount, 2) }}</td>
