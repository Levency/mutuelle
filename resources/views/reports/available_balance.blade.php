...
<div class="content">
    ...
    <div class="audit-box">
        <div class="line">
            ...
            <span class="val">{{ \App\Models\Setting::get('currency', 'Gourdes') }} {{ number_format($gross_balance, 2) }}</span>
        </div>
        <div class="line">
            <span class="lbl">Moins : Prêts Actifs (Encours non remboursés)</span>
            <span class="val" style="color:#dc2626">- {{ \App\Models\Setting::get('currency', 'Gourdes') }} {{ number_format($loans_encumbrance, 2) }}</span>
        </div>
        <div class="line total">
            <span class="lbl">SOLDE DISPONIBLE BRUT</span>
            <span class="val">{{ \App\Models\Setting::get('currency', 'Gourdes') }} {{ number_format($available_raw, 2) }}</span>
        </div>
    </div>
    ...
    <div class="audit-box">
        <div class="line">
            ...
            <span class="val">{{ \App\Models\Setting::get('currency', 'Gourdes') }} {{ number_format($solidarity, 2) }}</span>
        </div>
